...
import { PriceTable, ThirdPartyZoneMap } from '../../shared/types/carrier';

interface EditZoneMapModalProps {
  account: PriceTable;
}

const EditPriceTableZoneMapModal = ({
  account
}: EditZoneMapModalProps): ReactElement => {
...
export default EditPriceTableZoneMapModal;
